...
export default function ReviewInsights() {
  const shopifyAppLink =
    "https://apps.shopify.com/gwl-reviews?surface_intra_position=4&surface_type=partners&surface_version=simplified";
        ...
        <section className="space-y-4">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 text-sm md:text-base leading-relaxed">
              The ReviewInsights Management Hub provides merchants with a complete dashboard to track review summaries, average ratings, bulk import/export CSV controls, and moderation tabs for product ratings and bundle review approvals.
            </p>
          </div>
        </section>
